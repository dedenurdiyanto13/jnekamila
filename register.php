...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>daftar</h3>
      <input type="text" name="name" required placeholder="masukkan nama lengkap anda" class="box" maxlength="50">
      ...
      <input type="number" name="number" required placeholder="masukkan no telp anda" class="box" min="0" max="9999999999999" maxlength="13">
